  ...
  return (
    <div className="flex h-full overflow-hidden flex-col [@media(min-width:900px)]:flex-row">
      ...
      <div className="[@media(min-width:900px)]:hidden flex flex-col flex-shrink-0 border-b">
        ...
        <div
          className={`flex overflow-x-auto gap-1 px-3 py-2 ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}
        >
          {tabs.map((tab) => (
            <button
              key={tab.id}
              ...
              <div className="px-6 py-5">
                <div className="space-y-6">
                  <div>
                    ...
                    <p
                      className={`mt-2 text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}
                    >
                      {t('aboutDescription')}
                    </p>
                  </div>
                  ...
                  <div className="grid gap-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p
                          className={`text-sm mt-0.5 truncate ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}
                        >
